...
const restaurantJsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      url: "https://centrestjhotpot.ca/",
      name: "Centre Street Japanese HotPot Calgary | $28.99 AYCE",
      description: "Visit Centre Street Japanese HotPot in Calgary: $28.99 AYCE + tax, soup base included, or $19.99 personal hot pot. View the menu and book online.",
      inLanguage: "en-CA",
    ...
    },
    {
      ...
      potentialAction: { "@type": "ReserveAction", target: { "@type": "EntryPoint", urlTemplate: "https://reservation.centrestjhotpot.ca/book", actionPlatform: "https://schema.org/DesktopWebPlatform" }, result: { "@type": "Reservation", name: "Table reservation" } },
      sameAs: [
