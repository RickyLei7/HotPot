...
function renderNav(data) {
  ...
  return `<nav class="site-nav" aria-label="主要導覽">
      ...
      <div class="language-switch" aria-label="切換網站語言"><a class="language-option" hreflang="en-CA" lang="en-CA" href="${data.englishPath}">EN</a><a class="language-option is-active" aria-current="page" hreflang="zh-Hant-CA" lang="zh-Hant" href="${data.path}">繁中</a></div>
