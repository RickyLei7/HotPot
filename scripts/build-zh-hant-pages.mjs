...
<html lang="zh-Hant">
  <head>
    ...
    <link rel="stylesheet" href="/site.css?v=20260814-poster-modal-v2" />
  ...
  <body>
    ${renderNav(data)}
    <main>
      <section id="ayce" class="homepage-ayce"><div class="homepage-ayce-copy"><p class="eyebrow">卡加利火鍋自助</p><h1>$28.99 火鍋自助</h1><p class="homepage-lead">15 款湯底自由選擇，AAA 牛肉、羊肉、豬肉或雞肉由服務員協助新鮮下單。</p><p>鍋底已包含在價格內，適合家庭聚餐、朋友相聚與多人用餐。</p><div class="hero-actions"><a class="primary-action" href="tel:+14034553188">致電預訂火鍋自助</a><a class="secondary-action" href="/zh-hant/ayce-hot-pot-calgary/">查看火鍋自助詳情</a></div></div><a class="homepage-ayce-media poster-thumbnail" href="#homepage-ayce-image" aria-label="查看完整火鍋自助圖片"><img src="/assets/ayce-hotpot.webp" alt="鼎鑽火鍋火鍋自助" width="1024" height="1536" fetchpriority="high" decoding="async" /><span>15 款湯底</span><strong class="poster-open-label">查看完整圖片</strong></a></section>
      <section class="poster-modal" id="homepage-ayce-image" role="dialog" aria-modal="true" aria-labelledby="homepage-ayce-image-title" data-close-target="ayce"><a class="modal-backdrop" href="#ayce" aria-label="關閉完整火鍋自助圖片"></a><div class="poster-frame"><span class="modal-label" id="homepage-ayce-image-title">火鍋自助完整圖片</span><a class="modal-close" href="#ayce">關閉</a><img src="/assets/ayce-hotpot.webp" alt="鼎鑽火鍋火鍋自助完整圖片" width="1024" height="1536" /></div></section>
