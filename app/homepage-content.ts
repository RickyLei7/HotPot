...
export const homepageContent: { en: HomepageContent; zhHant: HomepageContent } = {
  en: {
    ...
    ayce: {
      ...
      snackRule: "The snack upgrade is +$3.99 per person. Everyone at the same table must upgrade together.",
  ...
  zhHant: {
    ...
    ayce: {
      ...
      snackTitle: "+$3.99 升級 19 款小吃任點",
      snackLead: "先吃招牌台式鹽酥雞，再選章魚小丸子、香酥雞排、黃金炸饅頭、酥炸魷魚鬚等小吃。",
      snackRule: "小吃任點升級每位 +$3.99，同桌客人必須一起升級。",
