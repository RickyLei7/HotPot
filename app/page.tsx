...
const restaurantJsonLd = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      description: "Visit Centre Street Japanese HotPot in Calgary: $28.99 AYCE + tax, soup base included, or $19.99 personal hot pot. View the menu and call (403) 455-3188.",
      inLanguage: "en-CA",
