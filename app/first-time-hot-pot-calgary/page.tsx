    ...
    <main>
      ...
      <section className="weekly-picks">
        ...
        <div className="weekly-picks-grid">
          ...
          <article><img src="/assets/ayce-menu-2026-08-19-360.webp" srcSet="/assets/ayce-menu-2026-08-19-360.webp 360w, /assets/ayce-menu-2026-08-19-480.webp 480w" sizes="(max-width: 560px) 112px, (max-width: 1100px) 50vw, 33vw" alt="All-you-can-eat hot pot menu in Calgary" width="480" height="600" loading="lazy" decoding="async" /><div><h3>Step 2 Choose your meal</h3><p>Pick a Hot Pot Set or AYCE Hot Pot, then order meats through your server for AYCE.</p></div></article>
