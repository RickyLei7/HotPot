...
function renderHomePage(data) {
  const snackCards = [
    ["招牌台式鹽酥雞", "/assets/ayce-signature-fried-chicken-2026-09-21-320.webp", "/assets/ayce-signature-fried-chicken-2026-09-21-224.webp 224w, /assets/ayce-signature-fried-chicken-2026-09-21-320.webp 320w, /assets/ayce-signature-fried-chicken-2026-09-21-480.webp 480w", true],
    ["章魚小丸子", "/assets/ayce-takoyaki-2026-09-21-320.webp", "/assets/ayce-takoyaki-2026-09-21-224.webp 224w, /assets/ayce-takoyaki-2026-09-21-320.webp 320w", false],
...
<html lang="zh-Hant">
  <head>
    ...
    <link rel="stylesheet" href="/site.css?v=20260921-performance2" />
    <script defer src="/language-routes.js?v=20260813-bilingual"></script>
    <script defer src="/site-events.js?v=20260921-performance"></script>
  ...
  <body>
    ...
    <main>
      ...
      <section id="light-meals" class="light-meals-section"><div class="section-heading compact"><p class="eyebrow">不只火鍋</p><h2>台式招牌飯麵</h2><p>想吃得快又有飽足感，可選台式飯麵。</p></div><div class="light-meal-grid">${homeMeals.map(([slug, name, price, description]) => `<article class="light-meal-card"><img src="/assets/light-meals/${slug}-640.webp" srcset="/assets/light-meals/${slug}-320.webp 320w, /assets/light-meals/${slug}-480.webp 480w, /assets/light-meals/${slug}-640.webp 640w, /assets/light-meals/${slug}-1024.webp 1024w" sizes="(max-width: 560px) 44vw, (max-width: 1100px) 45vw, 30vw" alt="鼎鑽火鍋${name}" width="1024" height="704" loading="lazy" decoding="async" /><div><h3>${name}</h3><strong>${price}</strong><p>${description}</p></div></article>`).join("")}</div><a class="primary-action" href="/zh-hant/menu/">查看完整菜單</a></section>
      <section id="drinks" class="drink-feature"><div class="drink-feature-copy"><p class="eyebrow">茶飲 奶茶與特色飲品</p><h2>選一杯喜歡的飲料</h2><p>甜度和冰量都可以選擇，茶飲與奶茶也可以做熱飲。</p><strong class="drink-discount">任點火鍋或招牌餐點 飲料可享九折優惠</strong><details class="home-details"><summary>飲品種類與價格</summary><div class="drink-category-grid">${homeDrinks.map(([name, price]) => `<p><span>${name}</span><strong>${price}</strong></p>`).join("")}</div></details></div><img src="/assets/milk-tea-photo-480-perf.webp" srcset="/assets/milk-tea-photo-320.webp 320w, /assets/milk-tea-photo-480-perf.webp 480w, /assets/milk-tea-photo-640.webp 640w, /assets/milk-tea-photo.webp 900w" sizes="(max-width: 760px) min(74vw, 250px), 380px" alt="鼎鑽火鍋奶茶與特色飲品" width="900" height="1200" loading="lazy" decoding="async" /></section>
      <section id="visit" class="homepage-visit"><div class="section-heading compact"><p class="eyebrow">到店用餐</p><h2>位於卡加利 Centre Street</h2></div><div class="visit-grid"><article><h3>營業時間</h3><p>週一至週五 5:00 PM-10:30 PM</p><p>週六及週日 12:00 PM-10:30 PM</p><a href="/zh-hant/restaurant-info/">查看完整餐廳資料</a></article><article><h3>預訂座位</h3><p>可網上訂位；團體聚餐或查詢今天座位，也可直接致電。</p><a href="https://reservation.centrestjhotpot.ca/book" data-track-label="online_booking" aria-haspopup="dialog" data-reservation-launcher>網上訂位</a><p><a href="tel:+14034553188">(403) 455-3188</a></p></article><article><h3>Google 地圖導航</h3><p>2213 Centre St N #2243, Calgary, AB T2E 2T4</p><a href="https://www.google.com/maps/dir/?api=1&amp;destination=2213+Centre+St+N+%232243%2C+Calgary%2C+AB+T2E+2T4" target="_blank" rel="noreferrer">Google 地圖導航</a></article><article><h3>分享用餐體驗</h3><p>歡迎在 Google 分享用餐體驗。</p><a href="https://www.google.com/maps/place/Centre+Street+Japanese+Hotpot/@51.072234,-114.0656247,17z" target="_blank" rel="noreferrer">前往 Google 留下評論</a></article></div><div class="social-follow"><div><p class="eyebrow">追蹤我們</p><h3>新菜品 優惠與店內消息</h3></div>${renderSocialLinks()}</div></section>
    </main>
    <a class="reserve-sticky reserve-sticky-book" href="https://reservation.centrestjhotpot.ca/book" data-track-label="online_booking" aria-haspopup="dialog" data-reservation-launcher>網上訂位</a><a class="reserve-sticky reserve-sticky-phone" href="tel:+14034553188" aria-label="致電 (403) 455-3188">致電</a>
  </body>
</html>
`;
}
