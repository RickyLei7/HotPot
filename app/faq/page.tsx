...
const faqs = [
  ...
  [
    ...
    "Yes. All-You-Can-Eat Hot Pot is $28.99 + tax with soup base included. Meat is ordered through the server. Add 19 all-you-can-eat appetizers for +$5.99 per person; everyone at the same table must upgrade. Kids pricing is by height: under 100 cm free, 100-140 cm $12.99, and over 140 cm adult price.",
  ],
  [
