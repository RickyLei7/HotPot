...
const faqs = [
  ...
  [
    ...
    "Yes. AYCE Hot Pot is $28.99 + tax with soup base included. Meat is ordered through the server, and a 19-item snack upgrade is available for +$5.99 per person when everyone at the table upgrades.",
  ],
  [
