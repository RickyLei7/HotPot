...
function jsonLd(data) {
  ...
  if (data.schemaType === "Article") {
    ...
    pageEntity.dateModified = "2026-08-25";
...
<html lang="zh-Hant">
  <head>
    ...
    <link rel="preload" as="image" href="/assets/ayce-menu-2026-08-25-fast-480.webp" />
    <link rel="stylesheet" href="/site-20260825-performance.css" />
    <script defer src="/language-routes.js?v=20260813-bilingual"></script>
    <script defer src="/site-events.js?v=20260825-performance"></script>
    <script type="application/ld+json">${jsonLd(data)}</script>
  </head>
  <body>
    ${renderNav(data)}
    <main>
      <section id="ayce" class="homepage-ayce"><div class="homepage-ayce-copy"><p class="eyebrow">卡加利火鍋自助</p><h1>$28.99 火鍋自助</h1><p class="homepage-lead">15 款湯底自由選擇，AAA 牛肉、羊肉、豬肉或雞肉由服務員協助新鮮下單。</p><p>鍋底已包含在價格內，適合家庭聚餐、朋友相聚與多人用餐。</p><div class="hero-actions"><a class="primary-action" href="tel:+14034553188">致電預訂火鍋自助</a><a class="secondary-action" href="/zh-hant/ayce-hot-pot-calgary/">查看火鍋自助詳情</a></div></div><a class="homepage-ayce-media poster-thumbnail" href="#homepage-ayce-image" aria-label="15 款湯底 查看完整圖片"><img src="/assets/ayce-menu-2026-08-25-fast-480.webp" alt="鼎鑽火鍋火鍋自助" width="480" height="621" fetchpriority="high" decoding="async" /><span>15 款湯底</span><strong class="poster-open-label">查看完整圖片</strong></a></section>
      <section class="poster-modal" id="homepage-ayce-image" role="dialog" aria-modal="true" aria-labelledby="homepage-ayce-image-title" data-close-target="ayce"><a class="modal-backdrop" href="#ayce" aria-label="關閉完整火鍋自助圖片"></a><div class="poster-frame"><span class="modal-label" id="homepage-ayce-image-title">火鍋自助完整圖片</span><a class="modal-close" href="#ayce">關閉</a><img src="/assets/ayce-menu-2026-08-24-599.webp" alt="鼎鑽火鍋火鍋自助完整圖片" width="1200" height="1553" loading="lazy" decoding="async" /></div></section>
      ...
      <section class="poster-modal" id="beef-noodle-story-image" role="dialog" aria-modal="true" aria-labelledby="beef-noodle-story-image-title" data-close-target="beef-noodle"><a class="modal-backdrop" href="#beef-noodle" aria-label="關閉牛肉麵故事圖片"></a><div class="poster-frame"><span class="modal-label" id="beef-noodle-story-image-title">台灣傳統牛肉麵</span><a class="modal-close" href="#beef-noodle">關閉</a><img src="/assets/taiwanese-beef-noodle-story.webp" alt="${escapeHtml(story.imageAlt)}" width="1122" height="1402" loading="lazy" decoding="async" /></div></section>
