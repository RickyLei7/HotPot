...
export const homepageContent: { en: HomepageContent; zhHant: HomepageContent } = {
  en: {
    ...
    visit: {
      ...
      contactCopy: "Book online for reservations, group dining, or today's availability. You can also call (403) 455-3188.",
      reserve: "Book Online",
  ...
  zhHant: {
    ...
    visit: {
      ...
      details: "查看完整餐廳資料",
      contactTitle: "預訂座位",
      contactCopy: "訂位、團體聚餐或想確認今天座位，可以網上預訂，也可致電 (403) 455-3188。",
      reserve: "網上訂位",
