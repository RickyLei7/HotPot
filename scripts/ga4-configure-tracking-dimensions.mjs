...
const desiredDimensions = [
  ...
  ["booking_source", "Booking attribution source"],
  ["booking_medium", "Booking attribution medium"],
  ["booking_campaign_name", "Booking campaign name"],
  ["booking_campaign_id", "Booking campaign ID"],
  ["booking_campaign_content", "Booking campaign content"],
  ...
  ["booking_campaign_term", "Booking campaign term"],
