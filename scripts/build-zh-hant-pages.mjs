...
<html lang="zh-Hant">
  ...
  <body>
    ${renderNav(data)}
    <main>
      <section id="ayce" class="homepage-ayce"><div class="homepage-ayce-copy"><p class="eyebrow">卡加利火鍋自助</p><h1><span class="heading-unit">$28.99</span> <span class="heading-unit">火鍋自助</span></h1><p class="offer-tax">每位另加稅 鍋底已包含</p><p class="homepage-lead">15 款湯底自由選擇，AAA 牛肉、羊肉、豬肉或雞肉由服務員協助新鮮下單。</p><div class="hero-actions"><a class="primary-action" href="https://reservation.centrestjhotpot.ca/book">網上預訂火鍋自助</a><a class="secondary-action" href="tel:+14034553188">致電 (403) 455-3188</a><a class="secondary-action" href="/zh-hant/ayce-hot-pot-calgary/">查看火鍋自助詳情</a></div><div class="hero-visit"><a href="https://www.google.com/maps/dir/?api=1&amp;destination=2213+Centre+St+N+%232243%2C+Calgary%2C+AB+T2E+2T4" target="_blank" rel="noreferrer">2213 Centre St N #2243 · 導航</a><p>週一至週五 17:00–22:30 · 週六及週日 12:00–22:30</p></div></div><a class="homepage-ayce-media poster-thumbnail" href="#homepage-ayce-image" aria-label="查看完整火鍋自助圖片"><picture><source media="(max-width: 760px)" srcset="/assets/ayce-menu-2026-08-25-fast-360.webp 360w, /assets/ayce-menu-2026-08-25-fast-480.webp 480w" sizes="calc(100vw - 32px)" /><img src="/assets/ayce-menu-2026-08-25-fast-720.webp" srcset="/assets/ayce-menu-2026-08-25-fast-720.webp 720w, /assets/ayce-menu-2026-08-24-599.webp 1200w" sizes="42vw" alt="鼎鑽火鍋火鍋自助" width="1200" height="1553" fetchpriority="high" decoding="async" /></picture><span>15 款湯底</span><strong class="poster-open-label">查看完整圖片</strong></a></section>
